                ...
                <div class="max-w-md mx-auto">
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <c:if test="${lot.getOffersQuantity()!=0}" >
                            <table class="border-separate border border-green-800 ...">
                                ...
                                <tbody>
                                <c:forEach var="offer" items="${lot.getOffersQuantity()}" >
                                        <tr>
                                            <td class="border border-green-600 ..."><c:out value="${offer.getOwner().getName()}"/></td>
                                            <td class="border border-green-600 ..."><c:out value="${offer.getDescription()}"/></td>
