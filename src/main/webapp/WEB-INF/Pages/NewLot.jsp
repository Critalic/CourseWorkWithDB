                ...
                <div class="max-w-md mx-auto">
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <form action="${pageContext.request.contextPath}/lots/createLot" method="post">
                                <ul class="list-disc space-y-2">
                                    ...
                                    <li> Some information about it
                                        <div class="mb-3 pt-0">
                                            <input type="text" name = "lotInfo" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"/>
                                        </div>
                                    </li>
                                ...
                                <button class = "bg-blue-300 text-x1 font-semibold px-4 py-1 rounded hover:bg-blue-800 hover:text-white " type="submit">Create!</button>
                            </form>
                        </div>
                    </div>
                </div>
